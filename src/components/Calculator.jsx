...
function Calculator() {
  ...
  const [completeOparation, setCompleteOperation] = useState("");
  ...
  return (
    <div className="calculator">
      <div className="complete-operation">{completeOparation}</div>
      ...
      <div className="buttons">
        ...
        {operations.map((operation, index) => (
          <button key={index} onClick={() => handleOperation(operation)}>
            {operation}{" "}
          </button>
        ))}
